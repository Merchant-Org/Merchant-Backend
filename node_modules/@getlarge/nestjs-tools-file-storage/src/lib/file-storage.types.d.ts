...
export type FileStorageConfigFactory<T extends Record<string, any>, S extends Record<string, any>> = (setup: S) => T & FileStorageConfig;
export type FileStorageTransformPath = (fileName: string, methodType: MethodTypes, request?: Request, options?: any) => string | Promise<string>;
