import type { CreateReadStreamOptions, CreateWriteStreamOptions, DeleteFilesOptions, DownloadOptions, FileMetadata, FileOptions, GetFilesOptions, GetFilesResponse, MoveOptions, SaveOptions, Storage } from '@google-cloud/storage';
import type { DeleteOptions, ExistsOptions, GetMetadataOptions } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object';
import type { FileStorageDeleteDir, FileStorageDeleteFile, FileStorageDownloadFile, FileStorageDownloadStream, FileStorageFileExists, FileStorageGetFileMeta, FileStorageMoveFile, FileStorageReadDir, FileStorageUploadFile, FileStorageUploadStream } from './file-storage.types';
