import type { BigIntOptions, BigIntStats, Dirent, ObjectEncodingOptions, StatOptions, Stats, WriteFileOptions } from 'node:fs';
import type { FileStorageBaseArgs, FileStorageDeleteDir, FileStorageDownloadFile, FileStorageDownloadStream, FileStorageFileExists, FileStorageGetFileMeta, FileStorageMoveFile, FileStorageReadDir, FileStorageUploadFile, FileStorageUploadStream } from './file-storage.types';
...
export interface FileStorageLocalDownloadFile extends FileStorageDownloadFile {
    options?: {
        ...
        encoding: BufferEncoding;
        flag?: string;
    } | BufferEncoding | (ObjectEncodingOptions & {
        flag?: string;
    }) | undefined | null;
}
